    ...
    public partial class Form2 : Form
    {
        ...
        private void textBox1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                if (textBox1.Text == "")
                {
                    MessageBox.Show("กรุณาใส่ชื่อผู้เช่า", "ผิดพลาด");
                }
                else
                {
        ...
        {
            //items for comboBox1
            comboBox1.Items.Add("ปืนกล");
            comboBox1.Items.Add("ปืนสไนเปอร์");
            comboBox1.Items.Add("ปืนพก");
            comboBox1.Items.Add("ปืนกลเบา");
            comboBox1.Items.Add("ปืนลูกซอง");
        ...
        {
            if (comboBox1.Text == "ปืนกล") textBox3.Text = "200";
            if (comboBox1.Text == "ปืนสไนเปอร์") textBox3.Text = "300";
            if (comboBox1.Text == "ปืนพก") textBox3.Text = "150";
            if (comboBox1.Text == "ปืนกลเบา") textBox3.Text = "200";
            if (comboBox1.Text == "ปืนลูกซอง") textBox3.Text = "250";
        }
        ...
        private void textBox5_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                if (textBox5.Text == "")
                {
                    MessageBox.Show("กรุณาใส่จำนวนเงิน", "ผิดพลาด");
                }
                else
                {
                    ...
                    if (B < K)
                    {
                        MessageBox.Show("ยอดเงินไม่พอ", "ผิดพลาด");
                        textBox5.SelectAll();
                    }
                    else
                    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            comboBox1.Text = "--กรุณาเลือกประเภทปืน--";
            comboBox2.Text = "";
